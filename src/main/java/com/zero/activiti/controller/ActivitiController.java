...
public class ActivitiController {
    ...
    public String createProcess(MultipartFile xmlFile, String xmlName, MultipartFile pngFile, String pngName)
        ...
        deploymentBuilder.addInputStream(xmlName, xmlFile.getInputStream()).addInputStream(pngName,
                pngFile.getInputStream());
    ...
    public void readResource(@RequestParam String processInstanceId, HttpServletResponse response) throws Exception {
        // 获得流程实例
        ProcessInstance processInstance = runtimeService.createProcessInstanceQuery()
                .processInstanceId(processInstanceId).singleResult();
